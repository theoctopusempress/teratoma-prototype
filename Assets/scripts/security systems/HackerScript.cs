...
public class HackerScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            hackUiText += "0"+(j+1)+". "+ hackName[j] + ": " + hackCost[j] + "\n";
        }
    ...
    void Update()
    {
        if (nearHack)
        {
            ...
            //dialoging.sentences[0] = hackUiText;
            dialoging.StartCoroutine(dialoging.TypeSentence(hackUiText));
            dialoging.whichSentence = dialoging.sentences.Length;
